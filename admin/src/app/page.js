      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: "Total Orders", value: stats.totalOrders, color: "from-indigo-500 to-blue-500" },
              { label: "Total Sales (৳)", value: stats.totalSales, color: "from-green-500 to-emerald-500" },
              { label: "Pending Orders", value: stats.pendingOrders, color: "from-yellow-400 to-amber-500" },
              { label: "Delivered Orders", value: stats.deliveredOrders, color: "from-purple-500 to-indigo-600" },
            ].map((card, i) => (
              <div
                key={i}
          ...
          <div className="bg-white shadow rounded-xl p-4 sm:p-6">
            ...
            {topProducts.length > 0 ? (
                    ...
                    <tbody>
                      {topProducts.map((p, idx) => (
                        <tr key={idx} className="border-t hover:bg-gray-50">
                          ...
                          <td className="p-2 font-medium text-green-600">৳{p.revenue}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="text-center text-gray-500 py-10">No product data</div>
            )}
          </div>
