  ...
  return (
    <div className="fixed bottom-18 right-4 flex flex-col items-center space-y-3 z-[9999]">
      ...
      <button
        ...
        className="bg-blue-600 text-white p-3 rounded-full shadow-xl hover:bg-blue-700 transition-all duration-300 flex items-center justify-center transform-gpu z-[9999]"
